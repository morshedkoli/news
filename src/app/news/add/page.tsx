        ...
        return (
            <div className="flex min-h-[80vh] flex-col items-center justify-center p-4">
                <div className="w-full max-w-md text-center">
                    <Loader2 className="mx-auto mb-6 h-12 w-12 animate-spin text-indigo-600" />
                    <h2 className="mb-2 text-xl font-semibold text-slate-800">Generating Content</h2>
                    <p className="mb-8 text-slate-500">{progress.message}</p>
